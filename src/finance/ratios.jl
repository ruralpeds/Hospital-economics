...
Total excess of revenue over expenses (including non-operating) as a fraction
of total revenue. Captures investment income, grants, and other non-operating
sources that are critical for rural hospital sustainability.
"""
